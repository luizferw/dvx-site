    ...
    <div className="login">
      <section className="container rounded-lg shadow-md max-w-[44rem] mx-auto px-10 bg-white py-12 sm:mt-12 sm:px-20 md:mt-24">
        <div className="mb-8 p-4 text-center ">
          ...
          <h1 className="font-semibold text-3xl">Access your account</h1>
        </div>
        <form
          onSubmit={e => handleSubmit(e)}
          className="form-login text-left flex gap-5 flex-col py-10 border-y border-opacity-20 border-b-slate-400"
        >
